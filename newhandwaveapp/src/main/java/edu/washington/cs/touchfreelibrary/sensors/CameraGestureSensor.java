...
public class CameraGestureSensor extends ClickSensor implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public void start(JavaCameraView cameraView) {
        ...
        // EDITED BY JUSTIN LEE (12/04/18). Modified for gesture accuracy (Changed dividends. Originally 4).
        mMinDirectionalMotionX = mPreviewSize.width / 12;
        mMinDirectionalMotionY = mPreviewSize.height / 12;
    ...
    private Direction getGestureDirection(double gestureLength) {
        ...
        // EDITED BY JUSTIN LEE (12/04/18). Added shift factor for accuracy.
        double diffY = mEndPos.y - mStartPos.y + 20.0;
        ...
        // EDITED BY JUSTIN LEE (12/04/18). Commented out left and right directions so that only onGestureLeft and onGestureRight trigger (?).
